...
import { ChangePasswordModel, Homemodel,Loginmodel, MyCouponModel, NoticationSettingModel, OnboradingModel, OtpModel, PasswordRecoveryModel, SettingModel } from '../viewmodels';
...
const Routenavigation =() => {
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="MyCouponModel">
