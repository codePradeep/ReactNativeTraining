...
import { ChangePasswordModel, Homemodel,Loginmodel, OnboradingModel, OtpModel, PasswordRecoveryModel, SettingModel } from '../viewmodels';
...
const Routenavigation =() => {
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="ChangePasswordModel">
