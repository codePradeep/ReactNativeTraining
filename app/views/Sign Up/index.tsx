                    ...
                    <View style={styles.subcontainer}>
                        ...
                        <View>
                            <View style={styles.EmailContainer}>
                                ...
                                {!isvalidusername ? <Text style={styles.bottomsignuptext}>
                                    {/* {Constant.Validation.username} */}
                                    </Text> : <View />}
                            </View>
                            <View style={styles.input}>
                                <TextInput
                                    ...
                                    style={styles.textinput}
                                />
                             { isvalidusername?  <Image source={isvalidusername ? icon.check_tick : icon.wrong} style={styles.icon} />:null}
                            </View>
                        ...
                        <Abutton title={Constant.Button.Signup} OnPress={() =>{submit()}} />
