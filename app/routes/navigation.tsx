...
import { ChangePasswordModel, Homemodel,Loginmodel, NoticationSettingModel, OnboradingModel, OtpModel, PasswordRecoveryModel, SettingModel } from '../viewmodels';
...
const Routenavigation =() => {
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="NoticationSettingModel">
