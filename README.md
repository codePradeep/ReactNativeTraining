...
>The following documentation is only focussed on the react-native wrapper around our Android sdk. To know more about our react-native SDK, refer to the following documentation -[LInk](https://razorpay.com/docs/payment-gateway/react-native-integration/)
...
- Still having Problems with integrating our payment gateway? Follow [this link](https://github.com/razorpay/react-native-razorpay/wiki/FAQ's) for more info.
